...
class Viewer3DWidget(QtOpenGL.QGLWidget):
    def __init__(self, parent=None):
        ...
        self.color = [255,0,0]
        self.reflexion = (1.0, 1.0)
        self.coords = [(-0.5, 1.0), (-1.0, 0.0), (0.0, 0.0)]
...
class Ventana(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.reflexionxy.clicked.connect(self.reflexionxy)
        self.ui.reflexionx.clicked.connect(self.reflexionx)
        self.ui.reflexiony.clicked.connect(self.reflexiony)
    #slots
    @pyqtSlot()
    def original(self):
        self.viewer3D.reflexion = (1.0, 1.0)
