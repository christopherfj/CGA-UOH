...
class Viewer3DWidget(QtOpenGL.QGLWidget):
    def __init__(self, parent=None):
        ...
        self.color = [255,0,0]
        self.ciz = (0.0, 0.0)
        self.coords = [(0.0, 0.5), (0.5, 0.5), (0.5, 0.0), (0.0, 0.0)]
...
class Ventana(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.cizx.clicked.connect(self.cizx)
        self.ui.cizy.clicked.connect(self.cizy)
    #slots
    @pyqtSlot()
    def original(self):
        self.viewer3D.ciz = (0.0, 0.0)
        self.viewer3D.updateGL() 
    @pyqtSlot()
    def cizx(self):
        shx = 1
        shy = 0
        self.viewer3D.ciz = (shx, shy)
        self.viewer3D.updateGL()
    @pyqtSlot()
    def cizy(self):
        shx = 0
